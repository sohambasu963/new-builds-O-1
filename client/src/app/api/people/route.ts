...
export async function GET() {
  ...
  const res = await fetch(
    "https://digitalarchive.tpl.ca/search/*/objects/json?filter=classifications%3APicture%3BsubjectThesFilter%3Ahttp%25255C%3A%252F%252Fnodes.emuseum.com%252FY8SQECAV%252Fapis%252Femuseum%252Fnetwork%252Fv1%252Fvocabularies%252FtermMaster6713006",
    {
      headers: {
